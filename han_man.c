...
const char* words[] = {"ocean","water","kenji","ducky","kayze","eliza","smoke","train", "layer","alone","brain","craft","paint","flute","beach","heart","human","image","lemon","lucky","mouse","metal","noise","plane","phone","power","quiet","ready","store","sport","storm","today","table","under","video","watch","young", "slate", "crane", "brick", "slate", "stare", "raise", "arise", "farts", "bread"};
...
// Lucas until 88
    (strikes < 8); {
        ...
        if (strcmp(word, output_list) == 0) {
            printf("You guessed the word! Run the code again to play.\n");
              break;
